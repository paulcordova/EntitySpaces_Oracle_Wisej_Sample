...
namespace EntitySpaces_Oracle_Wisej_Sample
{
    public partial class Window1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            LoadAndBindData(dataGridView1, new CategoriesCollection(), new Categories());
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            LoadAndBindData(dataGridView1, new CustomersCollection(), new Customers());
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            LoadAndBindData(dataGridView1, new EmployeesCollection(), new Employees());
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
           ...
           LoadAndBindData(dataGridView1, new EmployeeterritoriesCollection(), new Employeeterritories());
        ...
        {
            UnCheckFilter();
            label_TableSelected.Text = "Sales Order";

            LoadAndBindData(dataGridView1, new OrdersCollection(), new Orders());
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            LoadAndBindData(dataGridView1, new OrderdetailsCollection(), new Orderdetails());
        }
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            LoadAndBindData(dataGridView1, new ProductsCollection(), new Products());
        }
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            LoadAndBindData(dataGridView1, new ShippersCollection(), new Shippers());
        }
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            LoadAndBindData(dataGridView1, new SuppliersCollection(), new Suppliers());
        }
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            ...
            LoadAndBindData(dataGridView1, new TerritoriesCollection(), new Territories());
        }
