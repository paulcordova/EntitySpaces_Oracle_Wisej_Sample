...
namespace BusinessObjects
{
	...
	{	
		...
		static public void Delete(System.Decimal regionid)
		{
			var obj = new Region();
	    ...
	    static public void Delete(System.Decimal regionid, esSqlAccessType sqlAccessType)
		{
			var obj = new Region();
			obj.Regionid = regionid;
			obj.AcceptChanges();
	...
	{
		public Region FindByPrimaryKey(System.Decimal regionid)
		{
	...
	abstract public partial class esRegion : esEntity
	{
		...
		public virtual bool LoadByPrimaryKey(System.Decimal regionid)
		{
		...
		public virtual bool LoadByPrimaryKey(esSqlAccessType sqlAccessType, System.Decimal regionid)
		{
		...
		private bool LoadByPrimaryKeyDynamic(System.Decimal regionid)
		{
		...
		private bool LoadByPrimaryKeyStoredProcedure(System.Decimal regionid)
		{
		...
		virtual public System.Decimal? Regionid
		{
			get
			{
				return base.GetSystemDecimal(RegionMetadata.ColumnNames.Regionid);
			}
			
			set
			{
				if(base.SetSystemDecimal(RegionMetadata.ColumnNames.Regionid, value))
				{
	...
	abstract public partial class esRegionQuery : esDynamicQuery
	{
		...
		{
			get { return new esQueryItem(this, RegionMetadata.ColumnNames.Regionid, esSystemType.Decimal); }
		} 
	...
	public partial class RegionMetadata : esMetadata, IMetadata
	{
		...
		protected RegionMetadata()
		{
			...
			c = new esColumnMetadata(RegionMetadata.ColumnNames.Regionid, 0, typeof(System.Decimal), esSystemType.Decimal);
